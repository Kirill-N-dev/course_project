...
// Получение всех юзеров из локалсторидж с имитацией задержки (имхо первичное получение, не для полей)
const fetchAll = () =>
    new Promise((resolve) => {
...
// Имхо ф-ия для обновления юзеров в локалсторидже, для добавления туда написанного коммента
